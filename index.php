...
?>
    ...
    <div class="row">
      <div class="card col-3 m-3 ml-5" id="card1" style="display: none">
        <div class="card-body">
      ...
      <div class="card col-3 m-3" id="card2"style=" display: none">
        <div class="card-body">
        ...
        <div class="card-body">
          ...
          <div class="alert alert-secondary" role="alert">
            <div class="w" style="display:flex;">
              <img src="http://ddragon.leagueoflegends.com/cdn/10.21.1/img/champion/Shaco.png" class="img-fluid" alt="<?php echo $championg; ?>" id="champio">
              <div class="ml-4" style="width: 120px; height: 120px; background: center / cover no-repeat url('https://94.citoyens.com/wp-content/blogs.dir/2/files/2012/01/incendie-%C2%A9-Giorgio-Clementi-Fotolia.com_.jpg'); display:flex; justify-content: center; align-items: center;">
                <span class="badge badge-primary" style="font-size: 90%;" id="buildz" title="<?php echo json_encode($builds) ?>"><?php echo $builds[rand(0, count($builds) - 1)][1] ?></span>
              </div>
            </div>
          </div>
        </div>
